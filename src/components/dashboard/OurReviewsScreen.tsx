...
export default function OurReviewsScreen({ plan }: { plan?: string | null }) {
  ...
  function copyReviewText(review: LoggedReview) {
...
${businessName ? `Business: ${businessName}` : ""}`;
    ...
    fetch("/api/consultant", {
      ...
      .then((data: { response?: string }) => {
        ...
        const parsed = JSON.parse(raw) as typeof recoveryData;
  ...
  return (
    <div style={{ height: "100%", overflowY: "auto" }}>
        ...
        >
          ...
          >
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 600,
                      cursor: "pointer",
                      background: active ? pc.bg : "#E8DCC8",
                      color: active ? pc.text : "#A0856A",
                      boxShadow: "0 1px 3px rgba(44,26,14,0.08)",
            ...
            <textarea
              ...
              style={{ ...MODAL_INPUT, resize: "none" }}
            />

            {/* Date + Responded on same row */}
                ...
                <div style={{ display: "flex", gap: "6px" }}>
                  {([true, false] as const).map((val) => (
                    <button
                      key={String(val)}
                      type="button"
                      onClick={() => setForm((f) => ({ ...f, responded: val }))}
                      style={{
                        padding: "6px 12px",
                        borderRadius: "20px",
                        border: "none",
            ...
            {recoveryLoading ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                ...
                <div style={{ background: "#E8DCC8", borderRadius: "12px", padding: "14px" }}>
                  ...
                  <button
                    type="button"
                    onClick={() => copyRecovery("public", recoveryData!.public_response)}
                ...
                <div style={{ background: "#E8DCC8", borderRadius: "12px", padding: "14px" }}>
                  ...
                  <button
                    type="button"
                    onClick={() => copyRecovery("private", recoveryData!.private_message)}
                    style={{ background: "#2D9B8A", color: "white", borderRadius: "8px", padding: "6px 14px", fontSize: "11px", fontWeight: 600, border: "none", cursor: "pointer" }}
                  >
                ...
                <div style={{ background: "#E8DCC8", borderRadius: "12px", padding: "14px" }}>
                  ...
                  <button
                    type="button"
                    onClick={() => copyRecovery("checklist", recoveryData!.recovery_checklist.map((item, i) => `${i + 1}. ${item}`).join("\n"))}
                    style={{ background: "#2D9B8A", color: "white", borderRadius: "8px", padding: "6px 14px", fontSize: "11px", fontWeight: 600, border: "none", cursor: "pointer" }}
                  >
      ...
      {/* ── Review list ── */}
      <div style={{ padding: "0 24px 120px", display: "flex", flexDirection: "column", gap: "10px" }}>
        {reviews.length === 0 ? (
          <div style={{ ...CARD, padding: "52px 24px", textAlign: "center", marginTop: "8px" }}>
            <div style={{ fontSize: "2rem", marginBottom: "12px" }}>⭐</div>
            <p style={{ fontSize: "15px", fontWeight: 600, color: "#2C1A0E", marginBottom: "6px" }}>No reviews logged yet</p>
            <p style={{ fontSize: "13px", color: "#A0856A", lineHeight: 1.6 }}>
              Hit &ldquo;+ Log Review&rdquo; to add your first one.
            </p>
          </div>
        ) : (
          reviews.map((review) => {
            ...
            return (
              <div key={review.id} style={{ ...CARD, overflow: "hidden" }}>
                <div style={{ padding: "14px 14px 13px" }}>
                  ...
                  {/* Row 1: avatar · name · platform badge · date · delete */}
                  <div style={{ display: "flex", alignItems: "flex-start", gap: "11px" }}>
                    ...
                    <button
                      ...
                      style={{
                        background: "none", border: "none", cursor: "pointer",
                        color: "#C4A882", flexShrink: 0, padding: "2px",
                        lineHeight: 0,
                      }}
                    >
                    ...
                    <div style={{ marginTop: "10px", paddingLeft: "51px" }}>
                      ...
                      {longText && (
                        <button
                          ...
                          style={{
                            background: "none", border: "none", cursor: "pointer",
                            fontSize: "11px", color: "#A0856A", padding: "3px 0", marginTop: "1px",
                          }}
                        >
                          {isExpanded ? "Show less" : "Read more"}
                        </button>
                      )}
                      {/* Amber warning + Recovery Mode for low-star reviews */}
                      {review.rating <= 3 && (
                        ...
                        <div style={{ paddingLeft: "51px", marginTop: "8px" }}>
                          <div style={{ background: "rgba(45,155,138,0.09)", borderRadius: "10px", padding: "10px 12px" }}>
                            ...
                            <div style={{ display: "flex", gap: "6px" }}>
                              <button
                                type="button"
                                onClick={() => copyGeneratedReply(review.id)}
                                style={{
                                  background: "#2D9B8A", color: "white",
                              ...
                              <button
                                ...
                                disabled={generatingReplyId === review.id}
                                style={{
                                  background: "#E8DCC8", color: "#2C1A0E",
                                  border: "none", borderRadius: "6px",
                                  padding: "5px 12px", fontSize: "11px", fontWeight: 600,
                                  cursor: generatingReplyId === review.id ? "not-allowed" : "pointer",
                  ...
                  {/* Bottom: responded badge + toggle */}
                  <div
                    style={{
                      display: "flex", alignItems: "center", justifyContent: "space-between",
                      marginTop: "11px", paddingLeft: "51px",
                    }}
                  >
                    <span
                      style={{
                    ...
                    <button
                      ...
                      style={{
                        background: "none", border: "none", cursor: "pointer",
                        fontSize: "11px", color: "#A0856A", fontWeight: 500,
                        display: "inline-flex", alignItems: "center", gap: "4px",
                      }}
                    >
