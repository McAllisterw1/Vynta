...
// Screen order matches nav left→right: Stats=0, Requests=1, Home=2, Goals=3, Settings=4
interface Props {
  userName: string;
  plan: string | null;
...
export default function DashboardShell({
  ...
  const [activeIndex, setActiveIndex] = useState(2); // home by default

  const navigateTo = (index: number) => setActiveIndex(index);
  const goHome = () => setActiveIndex(2);
  ...
  return (
    ...
    >
      ...
      {/* Carousel track — 500% wide, one screen per 20% slot */}
      <div
        style={{
          display: "flex",
          width: "500%",
      ...
      >
        <div className="flex flex-col px-4 pt-2 pb-2">
          ...
          {/* Wave indicator — index directly matches visual slot */}
