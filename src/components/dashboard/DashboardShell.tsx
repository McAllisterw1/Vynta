...
// Tab indices: 0=Stats 1=Requests 2=Reviews 3=Home 4=Goals 5=Rivals 6=Reports 7=Settings
        ...
        <div className="flex flex-col px-3 pt-1.5 pb-1.5">
          <div className="flex">
            ...
            <button type="button" onClick={() => navigate(0)} className={tab(0)}>
              ...
              <span className="text-[8px] font-semibold uppercase tracking-wider">Stats</span>
            </button>
