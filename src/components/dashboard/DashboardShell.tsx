...
export default function DashboardShell({
  ...
  const tab = (i: number) =>
    `flex w-16 cursor-pointer flex-col items-center gap-1 py-0.5 transition-colors ${
      active === i ? "text-tobacco" : "text-tobacco-light/50 hover:text-tobacco-light"
    }`;
  ...
  return (
    <div style={{ position: "fixed", inset: 0, overflow: "hidden", background: "#FAF5E8" }}>
      ...
      <div style={{ width: "100%", height: "100%", overflow: "hidden" }}>
        ...
        {active === 1 && <div className={`screen-${direction}`} style={{ width: "100%", height: "100%" }}><RequestCampaign onBack={() => navigate(2)} /></div>}
        {active === 2 && <div className={`screen-${direction}`} style={{ width: "100%", height: "100%" }}><HomeScreen plan={plan} subscriptionStatus={subscriptionStatus} /></div>}
        {active === 3 && <div className={`screen-${direction}`} style={{ width: "100%", height: "100%" }}><GoalsScreen /></div>}
        {active === 4 && (
        ...
        <div className="flex flex-col px-4 pt-2 pb-2">
          <div className="flex">
            ...
            <button type="button" onClick={() => navigate(0)} className={tab(0)}>
              ...
              <span className="text-[9px] font-semibold uppercase tracking-wider">Stats</span>
            </button>
            ...
            <button type="button" onClick={() => navigate(1)} className={tab(1)}>
              ...
              <span className="text-[9px] font-semibold uppercase tracking-wider">Requests</span>
            </button>
            ...
            <button type="button" onClick={() => navigate(3)} className={tab(3)}>
              ...
              <span className="text-[9px] font-semibold uppercase tracking-wider">Goals</span>
            </button>
          ...
          <div className="relative mt-1 h-3">
            ...
            >
              <svg viewBox="0 0 62 19" fill="none" className="h-3 w-auto">
